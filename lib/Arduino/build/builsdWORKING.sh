...
avr-g++ -c -g -Os -w -std=gnu++11 -fpermissive -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics -Wno-error=narrowing -MMD -flto -mmcu=atmega32u4 -DF_CPU=16000000L -DARDUINO=10812 -DARDUINO_AVR_LEONARDO -DARDUINO_ARCH_AVR -DUSB_VID=0x2341 -DUSB_PID=0x8036 "-DUSB_MANUFACTURER=\"Unknown\"" "-DUSB_PRODUCT=\"Arduino Leonardo\"" -I../arduino/avr/cores/arduino -I../arduino/avr/variants/leonardo -I../libraries/Keyboard/src -I../libraries/HID/src -I../libraries/Mouse/src ../libraries/Keyboard/src/Keyboard.cpp -o Keyboard.cpp.o
avr-g++ -c -g -Os -w -std=gnu++11 -fpermissive -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics -Wno-error=narrowing -MMD -flto -mmcu=atmega32u4 -DF_CPU=16000000L -DARDUINO=10812 -DARDUINO_AVR_LEONARDO -DARDUINO_ARCH_AVR -DUSB_VID=0x2341 -DUSB_PID=0x8036 "-DUSB_MANUFACTURER=\"Unknown\"" "-DUSB_PRODUCT=\"Arduino Leonardo\"" -I../arduino/avr/cores/arduino -I../arduino/avr/variants/leonardo -I../libraries/Keyboard/src -I../libraries/HID/src -I../libraries/Mouse/src ../arduino/avr/libraries/HID/src/HID.cpp -o HID.cpp.o
avr-g++ -c -g -Os -w -std=gnu++11 -fpermissive -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics -Wno-error=narrowing -MMD -flto -mmcu=atmega32u4 -DF_CPU=16000000L -DARDUINO=10812 -DARDUINO_AVR_LEONARDO -DARDUINO_ARCH_AVR -DUSB_VID=0x2341 -DUSB_PID=0x8036 "-DUSB_MANUFACTURER=\"Unknown\"" "-DUSB_PRODUCT=\"Arduino Leonardo\"" -I../arduino/avr/cores/arduino -I../arduino/avr/variants/leonardo -I../libraries/Keyboard/src -I../libraries/HID/src -I../libraries/Mouse/src ../libraries/Mouse/src/Mouse.cpp -o Mouse.cpp.o

#avr-gcc-ar rcs ./ArduinoHIDKeyboardMouseCore.a ../core.a
avr-gcc-ar rcs ../HIDKeyboardMouseCore.a ./Keyboard.cpp.o
avr-gcc-ar rcs ../HIDKeyboardMouseCore.a ./HID.cpp.o
avr-gcc-ar rcs ../HIDKeyboardMouseCore.a ./Mouse.cpp.o
...
avr-gcc -w -Os -g -flto -fuse-linker-plugin -Wl,--gc-sections -mmcu=atmega32u4 -o main.elf main.o ../core.a ../HIDKeyboardMouseCore.a -lm
#avr-gcc -w -Os -g -flto -fuse-linker-plugin -Wl,--gc-sections -mmcu=atmega32u4 -o main.elf main.o Keyboard.cpp.o HID.cpp.o Mouse.cpp.o ../core.a -lm
#   ------->	#avr-gcc -w -Os -g -flto -fuse-linker-plugin -Wl,--gc-sections -mmcu=atmega32u4 -o /tmp/arduino_build_239665/KeyboardAndMouseControl.ino.elf /tmp/arduino_build_239665/sketch/KeyboardAndMouseControl.ino.cpp.o /tmp/arduino_build_239665/libraries/Keyboard/Keyboard.cpp.o /tmp/arduino_build_239665/libraries/HID/HID.cpp.o /tmp/arduino_build_239665/libraries/Mouse/Mouse.cpp.o ../core.a -L/tmp/arduino_build_239665 -lm
...
#Uso la libreria Keyboard alla versione 1.0.2 nella cartella: /home/gio/Scaricati/arduino-1.8.12-linux64/arduino-1.8.12/libraries/Keyboard
#Uso la libreria HID alla versione 1.0 nella cartella: /home/gio/Scaricati/arduino-1.8.12-linux64/arduino-1.8.12/hardware/arduino/avr/libraries/HID
#Uso la libreria Mouse alla versione 1.0.1 nella cartella: /home/gio/Scaricati/arduino-1.8.12-linux64/arduino-1.8.12/libraries/Mouse
